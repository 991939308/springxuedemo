...
/*************************2019年4月12日15:41:05 生成 TOKEN */
     ...
     * @return
     */
    public static String createJWT(long EXPIRE_TIME,String key,User user) {
...
//                .setExpiration(new Date(System.currentTimeMillis()+ttlMillis))
     ...
     * @return
     */
    public static Boolean isVerify(String token, Map<String,Object> user,String key) {
        //1、头部 载荷 重新是生成信息
        key = StringUtils.valueOf(user.get("password"));
        //2、和原来的信息进行对比
        //得到DefaultJwtParser
        Claims claims = Jwts.parser()
                //设置签名的秘钥
